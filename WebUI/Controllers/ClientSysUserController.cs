...
namespace ProcessAccelerator.WebUI.Controllers
{
    ...
    public class ClientSysUsrController : Cruder<UserProfile, UserProfileInput>
    {
        public ClientSysUsrController(ICrudService<UserProfile> service, IMapper<UserProfile, UserProfileInput> v, IWorkflowService wf)
        ...
        {
            var list = service.Where(rec => rec.ClientID == ((PAIdentity)User.Identity).clientID && rec.ClientID == ((PAIdentity)User.Identity).clientID);
