...
(function($) {
    ...
    function createHorizontalButtons(number, copyAllBtn) {
        if (number == 1) {
            return (copyAllBtn ? '       <button type="button" class="blue-bg btn btn-default atr" data-type="atr" style="margin-bottom: 5px;"><i class="icon-list"></i> <i class="icon-chevron-right"></i></button>' : '') +
                '       <button type="button" class="blue-bg btn btn-default ' + (copyAllBtn ? 'pull-right col-md-6' : 'col-md-12') + ' str" data-type="str" style="margin-bottom: 5px;" disabled><i class="icon-chevron-right"></i></button>';
        } else {
            return '       <button type="button" class="blue-bg btn btn-default ' + (copyAllBtn ? 'col-md-6' : 'col-md-12') + ' stl" data-type="stl" style="margin-bottom: 5px;" disabled><i class="icon-chevron-left"></i></button>' +
                (copyAllBtn ? '       <button type="button" class="blue-bg btn btn-default col-md-6 pull-right atl" data-type="atl" style="margin-bottom: 5px;"><i class="icon-chevron-left"></i> <i class="icon-list"></i></button>' : '');
        }
    }
    ...
    function createVerticalButtons(copyAllBtn) {
        return '   <div class="col-md-2 center-block" style="margin-top: ' + (copyAllBtn ? '80px' : '130px') +'">' +
            (copyAllBtn ? '       <button type="button" class="blue-bg btn btn-default col-md-8 col-md-offset-2 atr" data-type="atr" style="margin-bottom: 10px;"><i class="icon-list"></i> <i class="icon-chevron-right"></i></button>' : '') +
            '       <button type="button" class="blue-bg btn btn-default col-md-8 col-md-offset-2 str" data-type="str" style="margin-bottom: 20px;" disabled><i class="icon-chevron-right"></i></button>' +
            '       <button type="button" class="blue-bg btn btn-default col-md-8 col-md-offset-2 stl" data-type="stl" style="margin-bottom: 10px;" disabled><i class="icon-chevron-left"></i></button>' +
            (copyAllBtn ? '       <button type="button" class="blue-bg btn btn-default col-md-8 col-md-offset-2 atl" data-type="atl" style="margin-bottom: 10px;"><i class="icon-chevron-left"></i> <i class="icon-list"></i></button>' : '') +
            '   </div>';
    }
